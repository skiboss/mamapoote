      ...
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          <Link href="/" className="inline-block">
            <h1 className="text-3xl font-bold text-orange-600">Mamapoote</h1>
            <p className="text-gray-600 mt-1">Authentic African Cuisine</p>
          </Link>
        </div>
        ...
        <Card className="shadow-xl border-0">
          <CardHeader className="space-y-1">
            ...
            <CardDescription className="text-center">Sign in to your account to continue ordering</CardDescription>
          </CardHeader>
